          ...
          $(".repa").mouseleave(function(){
            ...
            $(".dv").mouseover(function(){
              ...
              $(".exp-est-img").attr('src',"img/dv.png");
                $(".text-block-est").append("<remover><h3>Leonardo Da Vinci Institute</h3><p><b>Multimedia Designer</b>  March 2006 - March 2009</p><p><em>Completed</em></p><p><b>Animation Cinema Director</b> March 2009 - December 2012</p><p><em>thesis Pending</em></p></remover>");
                $(".text-block-exp").append("<remover><h3>Leonardo Da Vinci Institute</h3><p><b>Professor in Multimedial Design Career & Animation Cinema Career</b></p><p><b>Modeling, Rendering, Rigging, Animation, Simulations</b> March 2013 - Current</p><p><em>https://www.davinci.edu.ar/</em></p></remover>");
                            });
